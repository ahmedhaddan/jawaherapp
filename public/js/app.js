...
try {
    ...
    let e = document.querySelector(".startbar-overlay"), t = (collapsedToggle?.addEventListener("click", function () {
...
try {
    let e = document.querySelectorAll('[data-bs-toggle="tooltip"]'), t = [...e].map(e => new bootstrap.Tooltip(e));
